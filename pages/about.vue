...
const values = [
  ...
  {
    title: 'Excellence',
    description: 'We strive for excellence in everything we do, from the smallest detail to the biggest project.',
    icon: 'i-heroicons-star'
  },
  {
    title: 'Simplicity',
    description: 'We believe in the power of simplicity to achieve great results.',
